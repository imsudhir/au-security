            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a  href="{{url('guard/dashboard')}}">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="{{url('guard/guard')}}">guard</a>
                                </li>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="@yield('dashboard_selected')">
                            <a href="{{url('guard/dashboard')}}" class="js-arrowp" >
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                            
                        </li>
                        
                        <li class="@yield('myJobs_selected')">
                            <a  href="{{url('guard/myJobs')}}">
                                <i class="fas fa-tag"></i>My Jobs</a>
                        </li>
                        <li class="@yield('newjobs_selected')">
                            <a  href="{{url('guard/newjobs')}}">
