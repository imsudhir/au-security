...
@section('container')
  ...
  <div class="row">
            ...
            <div class="card card-body ">
                        ...
                        <form id="demo-form1" action="{{url('/guard/attendance/signin')}}/{{$data->id}}" enctype="multipart/form-data" method="post" data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
    ...
    <div class="card card-body">
                        <!-- <img  id="blaha" alt="your image" style="margin:auto;" wid th="100" height="auto" />
                        <input class="btn p-5" style="opacity: 0; margin:auto;" type="file" onclick="yy()" onchange="document.getElementById('blaha').src = window.URL.createObjectURL(this.files[0])" />
                        <a id="signout_upload" href="#" class="btn btn-primary btn-lg">submit </a>  -->
    
                <form id="demo-form2" action="{{url('/guard/attendance/signout')}}/{{$data->id}}" enctype="multipart/form-data" method="post" data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
                    <div class="item form-group">
                    <div class="col-md-9 col-sm-9 ">
                        <img  id="sign_out_image" alt="your image" src="{{ asset('/media/'.$data->sign_out_image) }}" style="margin:auto;" wid th="100" height="auto" />
