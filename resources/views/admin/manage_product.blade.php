...
@section('manage_product_selected','active')
@section('container')
...
<div class="row card card-body pt-2 pr-5 pb-5 pl-5">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.manage_product_process') }}" method="post">
                        @csrf

                        <div class="form-group">
                            <label for="requirement" class="control-label mb-1">Requirement</label>
                            <input id="requirement" value="" name="requirement" type="text"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="join_date" value="" name="join_date" type="date"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="leave_date" value="" name="leave_date" type="date"
                                        class="form-control" aria-invalid="false">
                                    @error('leave_date')
                                        <span class="text-danger" role="alert">
                                            {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="in_time" value="" name="in_time" type="datetime-local"
                                        class="form-control" aria-invalid="false">
                                    @error('in_time')
                                        <span class="text-danger" role="alert">
                                            {{ $message }}
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="out_time" value="" name="out_time" type="datetime-local"
                                        class="form-control" aria-invalid="false">
                                    @error('out_time')
                                        <span class="text-danger" role="alert">
                                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input id="location_address" value="" name="location_address"
                        ...
                        <div class="form-group">
                            ...
                            <input id="city" value="" name="city" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input id="pincode" value="" name="pincode" type="text" class="form-control"
