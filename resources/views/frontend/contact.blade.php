            ...
            <div class="col-lg-8 text-center text-lg-right pt-4">
                <div class="d-inline-flex align-items-center">
                    <div class="d-inline-flex flex-column text-center pr-3 border-right">
                        <h6>Our Office</h6>
                        <p class="m-0">123 Street, XYZ, Australia</p>
                    </div>
                    <div class="d-inline-flex flex-column text-center px-3 border-right">
                        <h6>Email Us</h6>
                        <p class="m-0">operations@yoursecuritynsw.com.au</p>
                    </div>
        ...
        <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav m-auto py-4">
                    ...
                    <a href="{{url('asset-security')}}" class="nav-item nav-link">Asset Security</a>
                    <a href="{{url('retail-security')}}" class="nav-item nav-link">Retail Security</a>
                    <a href="{{url('asset-security')}}" class="nav-item nav-link">Corporate Security</a>
                
                   
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Services</a>
                        <div class="dropdown-menu text-capitalize">
                            <a href="{{url('crowd-control-and-private-event-security')}}" class="dropdown-item">Crowd Control & Private Event Security</a>
                            <a href="{{url('construction-sites')}}" class="nav-item nav-link">Construction Sites</a>
							<a href="{{url('guard-hireing-and-recruitment')}}" class="dropdown-item">Guard Hire & Recruitment</a>
							<a href="{{url('guard-hireing-and-recruitment')}}" class="dropdown-item">Static Security</a>
							<a href="{{url('residential-building-concierge')}}" class="dropdown-item">Residential Building / Concierge</a>
							<a href="{{url('residential-building-concierge')}}" class="dropdown-item">RSL/ Leagues / Bowling/ Clubs & Pubs</a>
							<a href="{{url('mobile-patrol-alar-response')}}" class="dropdown-item">Mobile Patrol & Alarm Response</a>
							<a href="{{url('shopping-malls')}}" class="dropdown-item">Shopping Malls</a>
							<a href="{{url('shopping-malls')}}" class="dropdown-item">Other Special Duties as may be required</a>
							<a href="{{url('cctv-cameras-installations')}}" class="dropdown-item">CCTV Cameras Installations</a>
                        </div>
                    </div>
